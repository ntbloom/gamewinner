...
EVAN_MIYA_FILE = Path(__file__).parent.joinpath("data").joinpath("evanmiya-recent.csv")


class IEvanMiyaStrategy2(IStrategy, ABC):
    """
        ...
        with open(EVAN_MIYA_FILE, "r") as f:
            ...
            for row in reader:
                ...
                if name in teams:
                    ...
                    setattr(team, "evanmiyaOBPRChange", float(evanmiyaOBPRChange))
                    setattr(team, "evanmiyaDBPRChange", float(evanmiyaDBPRChange))
                    setattr(team, "evanmiyaBPRChange", float(evanmiyaBPRChange))
